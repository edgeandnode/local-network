...
if curl "http://host.docker.internal:${GRAPH_NODE_GRAPHQL}/subgraphs/name/semiotic/tap" \
...
forge create --json --rpc-url="http://host.docker.internal:${CHAIN_RPC}" --mnemonic="${MNEMONIC}" \
...
sed -i "s/127.0.0.1:5001/host.docker.internal:${IPFS_RPC}/g" package.json
sed -i "s/127.0.0.1:8020/host.docker.internal:${GRAPH_NODE_ADMIN}/g" package.json
