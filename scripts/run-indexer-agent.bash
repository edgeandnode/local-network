...
export INDEXER_AGENT_PUBLIC_INDEXER_URL="http://${INDEXER_SERVICE_HOST}:${INDEXER_SERVICE_PORT}"
export INDEXER_AGENT_MNEMONIC="${MNEMONIC}"
export INDEXER_AGENT_INDEXER_ADDRESS="${ACCOUNT_ADDRESS}"
export INDEXER_AGENT_COLLECT_RECEIPTS_ENDPOINT="${GATEWAY_HOST}:${GATEWAY_PORT}/collect-receipts"
