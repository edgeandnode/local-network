...
| --------------------------------- | ---------------------------------------------------------------------- | ---------- |
| REO contract + deployment scripts | `/git/graphprotocol/contracts`                                         | `baseline` |
...
- Update `CONTRACTS_COMMIT` in `.env` to point to `baseline` branch (or merge relevant commit)
...
- [REO Contract Spec](file:///git/graphprotocol/contracts/baseline/packages/issuance/contracts/eligibility/RewardsEligibilityOracle.md)
- [REO Deployment Guide](file:///git/graphprotocol/contracts/baseline/packages/deployment/docs/deploy/RewardsEligibilityOracleDeployment.md)
