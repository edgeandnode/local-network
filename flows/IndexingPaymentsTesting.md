...
source ../../.env && export INDEXING_SIGNING_KEY="${RECEIVER_SECRET}" && export INDEXING_SERVER_URL="http://localhost:${DIPPER_ADMIN_RPC_PORT}/" && cargo run --bin dipper-cli -- [command]
```
